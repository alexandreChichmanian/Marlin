...
#define STRING_CONFIG_H_AUTHOR "(Alexandre Chichmanian, Geeetech pruse i3 pro b)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "Alex i3 Pro B"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -4, -10, -1.4 }
